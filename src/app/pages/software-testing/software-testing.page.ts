...
@Component({
  ...
  templateUrl: './software-testing.page.html',
  styleUrls: ['./software-testing.page.scss'],
})
export class SoftwareTestingPage implements OnInit {
  ...
  async navigateToLatencyTest(product: Product, step: string) {
    await this.router.navigate(['/software-testing-chooser', {productObjective: product.productObjective, step: step}]);
  }
